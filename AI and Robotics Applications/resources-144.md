...
• [Steerable Policies](https://steerable-policies.github.io) - Research on vision-language-action models for flexible control

![Image](https://pbs.twimg.com/media/HBTB6tha4AAE1Lx?format=jpg&name=medium)

---
### 🤖 Landslide Monitoring - Dense 3D Displacement Estimation
...
• [fusion4landslide GitHub](https://github.com/gseg-ethz/fusi) - Official implementation for landslide displacement estimation

![Image](https://pbs.twimg.com/media/HBPNmEfaoAANggo?format=jpg&name=small)

---
### 🤖 AI Theory - Theory of Space
...
• [ICLR 2026](https://iclr.cc) - Leading conference on learning representations
...
![Image](https://pbs.twimg.com/media/HBSnxezW8AAiXeD?format=jpg&name=small)

![Image](https://pbs.twimg.com/media/HBSnxhxbkAApXNM?format=jpg&name=small)

---
### 🤖 Logistics Automation - Amazon's Humanoid Delivery
...
![Image](https://pbs.twimg.com/media/HBUUBBoXIAEajGd?format=jpg&name=small)

---
### 💡 AI in Logistics - Generative AI for Delivery
...
• [Generative AI and Amazon Delivery](https://medium.com/@boringsage/generative-ai-will-take-over-amazon-delivery-heres-why-and-what-it-means-for-you-a1c24097f482) - Insights on AI's impact on logistics operations
...
![Image](https://pbs.twimg.com/amplify_video_thumb/2023452752379342849/img/GNkwZbofwHkWQPSE.jpg)

---
### 🚀 AI in Physical World - Large Geospatial Models
...
• [Niantic's Real-World AI Model](https://www.theinformation.com/articles/niantic-is-building-a-real-world-ai-model) - Article on building AI that interacts with the physical world
...
• [The Compression Company](https://compression.company/) - Developing solutions for satellite data management

• [TechCrunch Article](https://techcrunch.com/2024/02/08/the-compression-company-raises-3-4m-pre-seed-to-solve-satellite-data-backlog/) - News on the company's pre-seed funding round

![Image](https://pbs.twimg.com/media/HBT9tE_WsAAhfBk?format=jpg&name=small)
